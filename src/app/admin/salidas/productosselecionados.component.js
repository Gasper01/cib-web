             ...
             {productosSeleccionados.map((producto, index) => (
               ...
               <td className="px-6 py-4 justify-end space-x-3">
                 <div className="flex items-center justify-end space-x-3">
                   <button onClick={() => disminuirCantidad(index)} className="p-1 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-full focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700" type="button">
                   ...
                   <button onClick={() => aumentarCantidad(index)} className="p-1 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-full focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700" type="button">
                     <span className="sr-only">Quantity button</span>
               ...
               <td className="px-6 py-4 flex items-center justify-end">
                 <button onClick={() => eliminarProducto(index)} className="font-medium text-red-600 dark:text-red-500">Eliminar</button>
               </td>
             </tr>
          ))}
